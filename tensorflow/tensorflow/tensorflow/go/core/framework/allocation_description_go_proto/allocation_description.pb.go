...
func (x *AllocationDescription) Reset() {
	*x = AllocationDescription{}
	if protoimpl.UnsafeEnabled {
		mi := &file_tensorboard_compat_proto_allocation_description_proto_msgTypes[0]
...
func (*AllocationDescription) Descriptor() ([]byte, []int) {
	return file_tensorboard_compat_proto_allocation_description_proto_rawDescGZIP(), []int{0}
}
...
var File_tensorboard_compat_proto_allocation_description_proto protoreflect.FileDescriptor

var file_tensorboard_compat_proto_allocation_description_proto_rawDesc = []byte{
	...
	0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0b, 0x74, 0x65, 0x6e, 0x73, 0x6f, 0x72, 0x62,
	0x6f, 0x61, 0x72, 0x64, 0x22, 0xf9, 0x01, 0x0a, 0x15, 0x41, 0x6c, 0x6c, 0x6f, 0x63, 0x61, 0x74,
...
var (
	file_tensorboard_compat_proto_allocation_description_proto_rawDescOnce sync.Once
	file_tensorboard_compat_proto_allocation_description_proto_rawDescData = file_tensorboard_compat_proto_allocation_description_proto_rawDesc
)

func file_tensorboard_compat_proto_allocation_description_proto_rawDescGZIP() []byte {
	file_tensorboard_compat_proto_allocation_description_proto_rawDescOnce.Do(func() {
		file_tensorboard_compat_proto_allocation_description_proto_rawDescData = protoimpl.X.CompressGZIP(file_tensorboard_compat_proto_allocation_description_proto_rawDescData)
	})
	return file_tensorboard_compat_proto_allocation_description_proto_rawDescData
}

var file_tensorboard_compat_proto_allocation_description_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_tensorboard_compat_proto_allocation_description_proto_goTypes = []interface{}{
	(*AllocationDescription)(nil), // 0: tensorboard.AllocationDescription
}
var file_tensorboard_compat_proto_allocation_description_proto_depIdxs = []int32{
...
func init() { file_tensorboard_compat_proto_allocation_description_proto_init() }
func file_tensorboard_compat_proto_allocation_description_proto_init() {
	if File_tensorboard_compat_proto_allocation_description_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_tensorboard_compat_proto_allocation_description_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_tensorboard_compat_proto_allocation_description_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_tensorboard_compat_proto_allocation_description_proto_goTypes,
		DependencyIndexes: file_tensorboard_compat_proto_allocation_description_proto_depIdxs,
		MessageInfos:      file_tensorboard_compat_proto_allocation_description_proto_msgTypes,
	}.Build()
	File_tensorboard_compat_proto_allocation_description_proto = out.File
	file_tensorboard_compat_proto_allocation_description_proto_rawDesc = nil
	file_tensorboard_compat_proto_allocation_description_proto_goTypes = nil
	file_tensorboard_compat_proto_allocation_description_proto_depIdxs = nil
}
